...
public class PostsApiControllerTest {
    // JPA 기능을 test 할 때는 @SpringBootTest와 TestRestTemplate를 사용해야함
    ...
    * */
    ...
    /*
     * @WithMockUser - 인증된 모의(가짜) 사용자를 만들어서 사용하며 roles에 권한을 추가할 수 있음
    ...
    public void posts_create() throws Exception {
        ...
        /*
         * mvc.perform - 생성된 MockMvc를 통해 API를 테스트 함
